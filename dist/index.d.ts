...
declare class ConcurrentPromise<T> {
    task: () => Promise<T>;
    options: {
        abortOnFail?: true | undefined;
        queueRun?: true | undefined;
    } | undefined;
    promise?: Promise<T>;
    error?: any;
    queued: boolean;
...
export { AbortedError, ApiError, ClientError, Coding, ConcurrentPromise, Cookie, ErrorInfo, Errors, ExistsError, GenericError, HttpContentType, HttpError, HttpHeader, HttpMethod, InternalError, InternalServerError, InvalidArgumentError, Json, KV, Mime, NetworkError, NotFoundError, ParseError, Payload, PermissionDeniedError, PreconditionFailedError, Promises, RateLimitedError, Request, Response, SerializeError, SerializedType, ServerError, TimedOutError, Timer, URLBuilder, URLParams, UnavailableError, UnimplementedError, UnsupportedError, Yaml };
